...
namespace ECommerce.WebUI.Services.IdentityServices
{
...

    {
        ...
        public async Task<bool> GetRefreshToken()
        {
            ...
            var refreshToken =
                await _contextAccessor.HttpContext.GetTokenAsync(OpenIdConnectParameterNames.RefreshToken);
        ...
        public async Task<bool> SignInAsync(SignInDto signInDto)
        {
            ...
            ClaimsIdentity claimsIdentity = new(userValues.Claims, CookieAuthenticationDefaults.AuthenticationScheme,
                "name", "role");
